...
public class Form1099MISCDocumentRequest extends DocumentRequest {
  ...
  /**
   * The substitute payments in lieu of dividends or tax-exempt interest received by your broker on
  ...
  /**
   * The current year deferrals as a nonemployee under a nonqualified deferred compensation (NQDC)
   * plan that is subject to the requirements of section 409A plus any earnings on current and prior
   * year deferrals.
   */
  ...
  /**
   * The income as a non-employee under an NQDC plan that does not meet the requirements of section
